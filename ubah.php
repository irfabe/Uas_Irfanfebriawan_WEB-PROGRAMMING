...
<body background="img/bg/bck.png">
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Admin Data Siswa LP31 Tasikmalaya</a>
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="jurusan" name="jurusan">
                                   <option disabled selected value>--------------------------------------------Pilih
                                        Jurusan--------------------------------------------</option>
                                   <option value="Manajemen Informatika" <?php if ($siswa['jurusan'] == 'Manajemen Informatika') { ?>
                                        selected='' <?php } ?>>Manajemen Informatika</option>
                                   <option value="Administrasi Bisnis"
                                        <?php if ($siswa['jurusan'] == 'Administrasi Bisnis') { ?> selected=''
                                        <?php } ?>>Administrasi Bisnis</option>
                                   <option value="Manajemen Pemasaran" <?php if ($siswa['jurusan'] == 'Manajemen Pemasaran') { ?>
                                        selected='' <?php } ?>>Manajemen Pemasaran</option>
                                   <option value="Manajemen Keuangan Perbankan"
                                        <?php if ($siswa['jurusan'] == 'Manajemen Keuangan Perbankan') { ?> selected=''
                                        <?php } ?>>Manajemen Keuangan Perbankan</option>
